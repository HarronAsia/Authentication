...
<div class="container-fluid">
    <div class="row">
        ...
        <form action="/admin/admin/{{$user->id}}/confirm " method="POST" enctype="multipart/form-data">
            @csrf

            <div class="form-group">
            <label for="photo">Change Admin Image</label>
                <div>
