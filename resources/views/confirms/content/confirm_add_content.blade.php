...
<div class="container-fluid">
    <div class="row">
        ...
        <h3>Let's review and confirm your content before add to the website</h3>
        ...
        <form action="/manager/content/{{$content['event_id']}}/store" method="POST" enctype="multipart/form-data" align="center">
            @else
            <form action="/admin/content/{{$content['event_id']}}/store" method="POST" enctype="multipart/form-data" align="center">
                @endif
