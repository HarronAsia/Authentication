...
<div class="container-fluid">
    <div class="row">
        ...
        <form action="/manager/event/create" method="POST" enctype="multipart/form-data" align="center">
            @else
            <form action="/admin/event/create" method="POST" enctype="multipart/form-data" align="center">
                @endif
